...
export const en: Messages = {
  ...
  fillCar: {
    title: "Fill car",
    hint: "Sales per rep since the last van fill (Jordan time). When you increase quantities and save, orders and sales reset for a new cycle.",
    dateLabel: "Day",
    refresh: "Apply",
    allRepsTitle: "All reps — since last fill",
    colRep: "Rep",
    colOrders: "Orders",
    colSold: "Total sold",
    selectedRep: "Selected rep",
    soldThatDay: "Products sold since last fill",
    inventorySection: "Van inventory (fill / edit)",
    noSales: "No sales since last fill.",
    onCar: "On car",
    soldDelta: "Sold",
    addedDelta: "Added",
    deltaLegend: "Red = sold since fill · Green = added to van",
    selectRep: "Sales rep",
    qty: "Quantity on car",
    save: "Save inventory",
    saving: "Saving…",
    saveConfirmTitle: "Save van inventory?",
    saveConfirmText: "This updates van quantities. If any quantity increases, the orders and sales counter resets for this cycle.",
    cancelSave: "Cancel",
    saved: "Van inventory updated.",
    savedWithSalesReset: "Inventory saved. Orders and sales were reset.",
    loadFailed: "Failed to load.",
