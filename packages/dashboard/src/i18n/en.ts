...
export const en: Messages = {
  ...
  loyaltyStores: {
    ...
    editPointsCurrent: "Current balance",
    editPointsAmount: "Points",
    editPointsIncrease: "Increase",
    editPointsDecrease: "Decrease",
    editPointsPreview: (n: number) => `Balance after change: ${n}`,
    editPointsSave: "Save",
    editPointsCancel: "Cancel",
    editPointsSaved: "Points balance updated.",
    editPointsFailed: "Could not adjust points.",
    editPointsInvalid: "Enter a whole number greater than zero.",
    editPointsInsufficient: "Cannot decrease by more than the current balance.",
  },
  ...
  fillCar: {
    ...
    externalSalesHint:
      "Record a sale for this rep without linking a registered store or deducting van stock. The store name is free text for your records and the Orders tab.",
    externalSalesStoreName: "Store name",
    externalSalesStoreNameHint: "Any name — not linked to a registered store",
    externalSalesStoreNameRequired: "Enter a store name.",
    externalSalesPay: "Payment",
    externalSalesNote: "Note (optional)",
    externalSalesSubmit: "Save external sale",
    externalSalesSaving: "Saving…",
    externalSalesSaved: "External sale recorded.",
