...
export const en: Messages = {
  ...
  fillCar: {
    ...
    soldDelta: "Sold",
    addedDelta: "Added",
    deltaLegend: "Red = sold today · Green = added to van",
    selectRep: "Sales rep",
    qty: "Quantity on car",
    save: "Save inventory",
    saving: "Saving…",
  ...
  owner: {
    ...
    loyaltyPoints: (n: number) => `${n} pts`,
    loyaltyExpiryTitle: "Points validity",
    loyaltyExpiryHint: (days: number) =>
      `Points expire ${days} days after the first purchase that earns points — later purchases do not reset the period.`,
    loyaltyDaysLeft: (n: number) => `${n} days left`,
    loyaltyExpiresToday: "Expires today",
    loyaltyPeriodStart: "Period start",
    loyaltyExpiresOn: "Expires on",
    loyaltyNoActivePeriod: "The period starts on the first purchase that earns points.",
